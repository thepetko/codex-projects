...
<body>
  <header>
    ...
    <div class="subtitle">Interaktívne porovnanie historických archívnych cien z Dovolenka.SME.sk. Prísny filter 4*+, AI/UAI, hotelová pláž a bazén sa z archívnych kariet nepodarilo kompletne potvrdiť, preto dashboard oddeľuje destinácie, hotelové karty pri pláži a referenciu 2026.</div>
  </header>
  <main>
    <section class="kpis">
    ...
    <section class="split">
      <div class="panel">
        <h2>Hotelové karty</h2>
        <p>Filtrované podľa ovládacích prvkov vyššie. Kliknutím na hlavičku zoradíš tabuľku.</p>
  ...
  <script>
    ...
    function renderChart() {
      ...
      if (view === "beach") {
        title.textContent = "Hotelové karty 4*+ s plážou 0 m";
        subtitle.textContent = "Tieto riadky nemajú v archívnej karte potvrdené AI/UAI ani bazén.";
